...
<html lang="en">
    ...
    <body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<style>
                ...
                ::placeholder {
                    font-size: .85rem; /* Set your desired font size */
			...
			<div class="d-flex flex-column flex-center flex-column-fluid">
				<div class="d-flex flex-center w-lg-50 p-10">
                    <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                        <!--begin::Card-->
                        {{-- <div>
                            <img src="assets/images/bg7.png" width="600px" height="550px">
                        </div> --}}
                        <div class="bg-body d-flex flex-center flex-column align-items-stretch flex-center w-md-410px p-15 rounded-0">
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-5">
                                ...
                                <form method="POST" class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" action="{{ route('login') }}">
                                    ...
                                    <div class="fv-row mb-3 fv-plugins-icon-container">
                                        <div class="input-group">
                                            ...
                                            <input type="password" placeholder="Password" id="password" name="password" class="form-control  bg-transparent @error('password') is-invalid @enderror" />
                                        </div>
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                        ...
                                        <a href="javascript:void(0)" onclick="contactAdmin()" class="link-primary">
                                            Forgot Password ?
                                        </a>
                                    </div>
                                    <div class="d-grid mb-10">
                                        <button type="submit" class="btn btn-light-success ls-1 text-uppercase blocker fs-8 fw-bolder w-100">
                                            <span class="indicator-label fs-8 fw-bolder text-uppercase">Sign In</span>
                                        </button>
                                    </div>
    ...
    <script>
        ...
        {
            Swal.fire({
                html: "<span class='fs-8 text-uppercase fw-bold'>Please Contact Administrator!</span>",
                icon: "info",
                customClass: {
