                        ...
                        <div class="card card-flush h-md-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-senter">
                                        <span class="text-gray-900 fw-bolder fs-6">₱{{$response['query']->monthly}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-senter">
                                        <span class="text-gray-900 fw-bolder fs-6">{{empty($response['query']->last_payment_date)?"NO DATA":date('M d, Y', strtotime($response['query']->last_payment_date))}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-senter">
                                        <span class="text-gray-900 fw-bolder fs-6">{{empty($response['query']->upcoming_due_date)?"NO DATA":date('M d, Y', strtotime($response['query']->upcoming_due_date))}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-senter">
                                        <span class="text-gray-900 fw-bolder fs-6">
                                            @if($response['query']->status == "0")
                                            <span class="badge badge-light-danger fs-6">UNPAID</span>
                                            @elseif($response['query']->status == "1")
                    ...
                    <div class="col-lg-8">
                        <div class="card card-flush h-md-100">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table  class="table align-middle table-row-dashed border rounded fs-6 gy-5 gs-7 mt-5">
            							...
            							<tbody class="text-gray-600 fw-semibold">
                                            @foreach($response['datas'] as $data)
                                            <tr>
                                ...
                                <div class="mt-3">
									{{ $response['datas']->onEachSide(1)->links() }}
								</div>
                            </div>
                        </div>
                    </div>
