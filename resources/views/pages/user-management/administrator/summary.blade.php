...
<form method="POST" action="{{route('administrator.profile.update',['tab'=>'summary','id'=>Crypt::encrypt($response['administrator']->id)])}}">
    @csrf
    ...
    <div class="row">
        <div class="col-md-6 col-12">
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{$response['administrator']->name}}" class="form-control">
                @error("name")
        ...
        <div class="col-md-6 col-12">
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{$response['administrator']->email}}" class="form-control">
                @error("email")
                    <div class="text text-danger">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-md-6 col-12">
            <div class="mb-4">
                ...
                <input type="text" name="pincode" value="{{$response['administrator']->pincode}}" class="form-control">
                @error("pincode")
                    <div class="text text-danger">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-md-6 col-12">
            <div class="mb-4">
                ...
                <select name="status" class="form-control">
                    <option value="ACTIVE" {{$response['administrator']->status=="ACTIVE"?"Selected":""}}>ACTIVE</option>
                    <option value="INACTIVE" {{$response['administrator']->status=="INACTIVE"?"Selected":""}}>INACTIVE</option>
                </select>
            </div>
        </div>
        <div class="col-md-6 col-12">
