	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			<div id="kt_app_content_container" class="app-container container-fluid ">
			    <form method="POST" action="{{route('roles-and-permissions.update',['roles_and_permission'=>$id])}}">
			        @csrf
                    @method('PUT')
                    <div class="card">
    					<div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-12">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control" value="{{$response['role']->title}}" readonly>
                                            </div>
                                        </div>
                                    </div>
